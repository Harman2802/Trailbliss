...
.hero{
height:75vh;
background:url("image/qatar.jpg") center/cover no-repeat;
...
<section class="hero"><h1>Doha</h1></section>

<section class="container">
<h2>About Doha</h2>
<div class="section">
Doha is Qatar’s capital famous for modern skyline, museums, souq waqif and luxury lifestyle.
</div>
</section>
...
<section class="container">
<h2>Reviews</h2>
<div class="section">Modern city with amazing architecture and desert adventures.</div>
</section>
