...
<title>Trailbliss - Melbourne Tour Packages</title>
...
.hero{
height:75vh;
background:url("image/melbourne.jpg") center/cover no-repeat;
...
.section-box{background:#fff;padding:25px;border-radius:15px;box-shadow:0 8px 20px rgba(0,0,0,0.05);}
.right-content img{width:100%;border-radius:15px;}

.best-time-wrapper{display:grid;grid-template-columns:1fr 1fr;gap:25px;background:#fff;padding:25px;border-radius:15px;}
...
<section class="hero">
<div class="hero-text"><div class="big-title">Melbourne</div></div>
</section>

<section class="container">
<h2 class="main-title">Melbourne Tour Packages</h2>
<div class="content-area">
<div class="section-box">
<p>Melbourne is Australia’s cultural capital known for coffee culture, art lanes, sports events and modern lifestyle.</p>
</div>
<div class="right-content">
<img src="image/melbourne1.jpg">
</div>
</div>
</section>
...
<li><strong>Mar–May</strong><span>Autumn beauty</span></li>
<li><strong>Jun–Aug</strong><span>Winter festivals</span></li>
<li><strong>Sep–Nov</strong><span>Spring season</span></li>
</ul>
<div class="right-content">
<img src="image/melbourne2.jpg">
</div>
</div>
</section>
