...
<head>
  ...
  <title>Adventure Tours - Trailbliss</title>
...
<!-- MAIN TITLE -->
<div class="container">
  <h1 class="main-title">Adventure Tours</h1>
  <p class="route">Rivers - Mountains - Forests - Wildlife</p>

  <!-- IMAGE GALLERY -->
  <div class="gallery">
    <div class="gallery-left">
      <img src="image/ad1.jpg" alt="Adventure Tour">
    </div>
    <div class="gallery-right">
      <img src="image/rafting.jpg" alt="River Rafting">
      <img src="image/ad2.jpg" alt="Zipline Adventure">
      <img src="image/ad3.jpeg" alt="Jungle Safari">
      <img src="image/ad4.jpg" alt="Mountain Biking">
    </div>
  </div>
  ...
  <div class="content-area">
    ...
    <div class="left-content">
      <div class="section-box">
        <h2>Overview</h2>
        <p>
          Embark on adrenaline-packed adventure tours including river rafting,
          mountain biking, jungle safaris, and zip-lining. Perfect for thrill-seekers
      ...
      <div class="section-box">
        <h2>Itinerary</h2>
        <ul class="itinerary">
          <li>Day 01: Arrival & Orientation</li>
          <li>Day 02: White Water Rafting & Camping</li>
          <li>Day 03: Zipline & Hiking Trails</li>
          <li>Day 04: Jungle Safari & Wildlife Exploration</li>
          <li>Day 05: Mountain Biking & Departure</li>
        </ul>
      </div>
    </div>
  ...
  <section id="about">
    <h2>Why Choose Adventure Tours?</h2>
    <p>
      Push your limits, explore thrilling landscapes, and enjoy activities like rafting,
      biking, ziplining, and wildlife encounters safely with expert guidance.
    </p>

    <div class="about-grid">
      <div>
        <h4>Thrilling Activities</h4>
        <p>Experience adventure sports, trekking, and river rafting with professionals.</p>
      </div>

      <div>
        <h4>Camping & Bonfire</h4>
        <p>Night camping, bonfires, and bonding in the heart of nature.</p>
      </div>

      <div>
        <h4>Wildlife Exploration</h4>
        <p>Safaris, bird watching, and guided wildlife tours in natural habitats.</p>
      </div>

      <div>
        <h4>Safe & Guided Tours</h4>
        <p>Certified guides, safety equipment, and emergency support throughout.</p>
      </div>
    </div>
  </section>
  ...
  <div class="tour-section">
    <h2>Popular Adventure Packages</h2>
    <div class="tour-grid">
      <div class="tour-card">
        <img src="image/rafting.jpg" alt="River Rafting">
        <h4>River Rafting Expedition</h4>
        <p>3 Days / 2 Nights</p>
      </div>

      <div class="tour-card">
        <img src="image/ad5.jpg" alt="Zipline Adventure">
        <h4>Zipline Thrill</h4>
        <p>2 Days / 1 Night</p>
      </div>

      <div class="tour-card">
        <img src="image/ad6.jpg" alt="Mountain Biking">
        <h4>Mountain Biking Trail</h4>
        <p>4 Days / 3 Nights</p>
      </div>
    </div>
  </div>
  ...
  <!-- MORE ADVENTURES -->
  <div class="tour-section">
    <h2>More Adventure Experiences</h2>
    <div class="tour-grid">
      <div class="tour-card">
        <img src="image/ad7.jpg" alt="Jungle Safari">
        <h4>Jungle Safari</h4>
      </div>

      <div class="tour-card">
        <img src="image/ad7.jpg" alt="Paragliding">
        <h4>Paragliding Adventure</h4>
      </div>

      <div class="tour-card">
        <img src="image/ad2.jpg" alt="Camping">
        <h4>Camping in Wilderness</h4>
      </div>

      <div class="tour-card">
        <img src="image/ad3.jpeg" alt="Rock Climbing">
        <h4>Rock Climbing Challenge</h4>
      </div>
    </div>
  </div>
...
<section class="customer-reviews">
  ...
  <div class="reviews-container">
    <div class="review-card">
      ...
      <h3>Simran Kaur</h3>
      <span>India</span>
      <p>Amazing experience! Loved rafting and zipline activities.</p>
    </div>
    ...
    <div class="review-card">
      ...
      <h3>Michael Brown</h3>
      <span>USA</span>
      <p>Well-organized adventure tours. Guides were professional!</p>
    </div>
    ...
    <div class="review-card">
      ...
      <h3>Lara Singh</h3>
      <span>UK</span>
      <p>Thrilling activities and wonderful camping nights. Highly recommended!</p>
    </div>
  </div>
</section>
