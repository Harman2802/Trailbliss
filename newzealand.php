...
<title>Trailbliss - New Zealand Tour Packages</title>
...
.hero {
  height: 75vh;
  background: url("image/newzealand.jpg") center/cover no-repeat;
  display: flex;
  align-items: center;
...
<section class="hero">
  <div class="hero-text">
    <div class="small-title">Land of Kiwis</div>
    <div class="big-title">New Zealand</div>
  </div>
</section>

<!-- INTRO -->
<section class="container">
  <h2 class="main-title">New Zealand Tour Packages</h2>

  <div class="content-area">
    <div class="section-box">
      <p>
        New Zealand is a breathtaking travel destination known for its dramatic landscapes, snow-covered mountains, crystal-clear lakes, and lush green valleys. It is made up of two main islands, the North Island and South Island, each offering unique experiences for travelers.

        The country is famous for adventure tourism including bungee jumping, skydiving, hiking, and glacier trekking. Cities like Auckland and Wellington offer modern culture, while Queenstown is known as the adventure capital of the world.

        New Zealand is also home to Maori culture, scenic train journeys, and world-famous filming locations such as The Lord of the Rings. It is a perfect destination for nature lovers and adventure seekers alike.
      </p>
    </div>

    <div class="right-content">
      <img src="image/nz1.jpg">
    </div>
  </div>
</section>
  ...
  <div class="best-time-wrapper">
    ...
    <ul class="best-time-list">
      <li>
        ...
        <span>Best for beaches, hiking and outdoor activities.</span>
      </li>

      <li>
        <strong>Autumn (Mar–May)</strong>
        <span>Colorful landscapes and fewer tourists.</span>
      </li>

      <li>
        <strong>Winter (Jun–Aug)</strong>
        <span>Perfect for skiing in Queenstown and mountains.</span>
      </li>
    </ul>

    <div class="best-time-img">
      <img src="image/nz2.jpg">
    </div>
