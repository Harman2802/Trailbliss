...
<head>
  ...
  <title>Trailbliss - Amritsar Tour Packages</title>
...
<!-- HERO -->
<div class="hero" style="background-image:url('image/amritsar-main.jpeg');">
  <div class="hero-overlay"></div>
  <div class="hero-text">
    <div class="small-title">Welcome to Punjab</div>
    <div class="big-title">Amritsar</div>
  </div>
</div>
...
<section class="wildlife-section">
  <div class="wildlife-container">
    <div class="wildlife-text">
      <h1>Amritsar Tour Packages</h1>
      <p>
        Amritsar is the spiritual and cultural heart of Punjab, best known for the
        <b>Golden Temple (Sri Harmandir Sahib)</b>, one of the most sacred Sikh shrines.
        <br><br>
        The city reflects rich history, patriotism, and vibrant Punjabi culture.
        From the emotional <b>Jallianwala Bagh</b> to the electrifying
        <b>Wagah Border Retreat Ceremony</b>, Amritsar offers unforgettable experiences.
        <br><br>
        Our Amritsar packages include heritage walks, temple visits, food trails,
        Wagah Border experience, luxury hotels, and guided sightseeing.
      </p>
    </div>

    <div class="wildlife-image">
      <img src="image/golden-temple.jpg" alt="Golden Temple Amritsar">
    </div>
  </div>
</section>
...
<section class="section">
  <h2>Popular Amritsar Tour Packages</h2>
  <div class="card-grid">

    <div class="card">
      <img src="image/amritsar-3.jpg">
      <div class="card-content">
        <a href="#">
          2 Nights & 3 Days
          <h4>Golden Temple Special</h4>
          <p>Golden Temple, Jallianwala Bagh & local markets.</p>
        </a>
      </div>
    </div>

    <div class="card">
      <img src="image/amritsar-2.jpg">
      <div class="card-content">
        <a href="#">
          3 Nights & 4 Days
          <h4>Amritsar with Wagah Border</h4>
          <p>Patriotic retreat ceremony & heritage sites.</p>
        </a>
      </div>
    </div>

    <div class="card">
      <img src="image/amritsar-food.jpg">
      <div class="card-content">
        <a href="#">
          2 Nights & 3 Days
          <h4>Amritsar Food & Culture Tour</h4>
          <p>Punjabi food walk, culture & shopping.</p>
        </a>
      </div>
    </div>

    <div class="card">
      <img src="image/punjab.jpg">
      <div class="card-content">
        <a href="#">
          5 Nights & 6 Days
          <h4>Punjab Heritage Tour</h4>
          <p>Amritsar, Chandigarh & cultural villages.</p>
        </a>
      </div>
    </div>
...
<section class="best-time-section">
  <div class="bt-container">
    <div class="bt-left">
      <h2>Best Time to Visit <br> Amritsar</h2>

      <div class="bt-list">
        <div class="bt-item">
          <span>01</span>
          <h3>Winter (Oct – March)</h3>
          <p>Best weather for sightseeing and temple visits.</p>
        </div>

        <div class="bt-item">
          <span>02</span>
          <h3>Summer (April – June)</h3>
          <p>Hot days but vibrant evenings and festivals.</p>
        </div>

        <div class="bt-item">
          <span>03</span>
          <h3>Gurpurab Festivals</h3>
          <p>Spiritual celebrations at the Golden Temple.</p>
        </div>
      </div>

      <div class="bt-text">
        <p>
          Winter season is ideal for Amritsar tours.
          Gurpurab festivals add divine charm and cultural richness.
        </p>
      </div>
    </div>

    <div class="bt-right">
      <img src="image/amritsar-1.jpg">
    </div>
  </div>
</section>
...
<section class="feedback-section" id="feedback-section">
  ...
  <div class="feedback-card active">
    <div class="feedback-text center">
      <h4>Spiritual & Patriotic Experience</h4>
      <p>
        The Golden Temple visit and Wagah Border ceremony arranged by Trailbliss
        were truly unforgettable.
      </p>
      <p class="reviewer">– Harpreet Singh</p>
    </div>
  </div>
</section>
...
<section class="about-section" id="about">
  <h2>About <span>Amritsar Tourism</span></h2>
  <div class="about-content">
    <p class="intro">
      Amritsar stands as a symbol of spirituality, sacrifice, and Punjabi pride.
      Our Amritsar packages cover religious sites, freedom landmarks,
      food experiences, heritage walks, and comfortable stays with expert guides.
    </p>
  </div>
</section>
