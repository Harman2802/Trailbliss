...
<head>
  ...
  <title>Darjeeling Tours - Trailbliss</title>
...
#about {
  padding: 50px 20px;
  text-align: center;
  background: #f3f8ff; /* Light cool background */
}
...
<!-- MAIN TITLE -->
<div class="container">
  <h1 class="main-title">Darjeeling Hill Station Tours</h1>
  <p class="route">Darjeeling - Gangtok - Kalimpong - Tea Gardens</p>

  <!-- IMAGE GALLERY -->
  <div class="gallery">
    <div class="gallery-left">
      <img src="image/darjeeling-1.jpg" alt="Darjeeling">
    </div>
    <div class="gallery-right">
      <img src="image/darjeeling-6.jpg" alt="Darjeeling Sightseeing">
      <img src="image/darjeeling-2.jpg" alt="Tea Gardens">
      <img src="image/darjeeling-3.jpg" alt="Himalayan Views">
      <img src="image/darjeeling-4.jpg" alt="Darjeeling Ropeway">
    </div>
  </div>
  ...
  <div class="content-area">
    ...
    <div class="left-content">
      <div class="section-box">
        <h2>Overview</h2>
        <p>
          Darjeeling, the Queen of Hills, is famous for its tea gardens, scenic vistas, 
          and colonial charm. Ideal for honeymooners, families, and nature lovers. 
          Enjoy toy train rides, monasteries, and breathtaking Himalayan views.
        </p>
      </div>
      ...
      <div class="section-box">
        <h2>Itinerary</h2>
        <ul class="itinerary">
          <li>Day 01: Arrival in Siliguri – Transfer to Darjeeling</li>
          <li>Day 02: Darjeeling Local Sightseeing – Tiger Hill & Batasia Loop</li>
          <li>Day 03: Darjeeling – Tea Garden Tour & Toy Train Ride</li>
          <li>Day 04: Excursion to Gangtok / Kalimpong</li>
          <li>Day 05: Return to Siliguri – Departure</li>
        </ul>
      </div>
    </div>
  ...
  <div class="tour-section">
    <h2>Popular Darjeeling Packages</h2>
    <div class="tour-grid">
      <div class="tour-card">
        <img src="image/darjeeling-1.jpg" alt="Darjeeling Tour">
        <h4>Darjeeling Tea Garden Tour</h4>
        <p>4 Nights / 5 Days</p>
      </div>

      <div class="tour-card">
        <img src="image/darjeeling-5.jpg" alt="Gangtok Tour">
        <h4>Darjeeling & Gangtok Explorer</h4>
        <p>5 Nights / 6 Days</p>
      </div>

      <div class="tour-card">
        <img src="image/darjeeling-6.jpg" alt="Kalimpong Tour">
        <h4>Darjeeling & Kalimpong Retreat</h4>
        <p>3 Nights / 4 Days</p>
      </div>
    </div>
  </div>
...
<section id="about">
  <h2>About Darjeeling Tours</h2>
  <p>
    Explore Darjeeling’s tea gardens, ropeways, monasteries, and scenic viewpoints. 
    Enjoy a mix of adventure, relaxation, and cultural experiences.
  </p>

  <div class="about-grid">
    <div>
      <h4>Tea Garden Tours</h4>
      <p>Visit lush tea plantations and experience tea tasting sessions.</p>
    </div>

    <div>
      <h4>Toy Train Experience</h4>
      <p>Ride the iconic Darjeeling Himalayan Railway for unforgettable views.</p>
    </div>

    <div>
      <h4>Himalayan Views</h4>
      <p>Catch sunrise views of Kanchenjunga and surrounding mountains.</p>
    </div>

    <div>
      <h4>Cultural Tours</h4>
      <p>Visit monasteries, local markets, and heritage sites.</p>
    </div>
  </div>
</section>
