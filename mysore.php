...
<head>
  ...
  <title>Trailbliss - Mysore Tour Packages</title>
...
<!-- HERO -->
<div class="hero" style="background-image:url('image/mysore-main.jpg');">
  <div class="hero-overlay"></div>
  <div class="hero-text">
    <div class="small-title">Welcome to Karnataka</div>
    <div class="big-title">Mysore</div>
  </div>
</div>
...
<section class="wildlife-section">
  <div class="wildlife-container">
    <div class="wildlife-text">
      <h1>Mysore Tour Packages</h1>
      <p>
        Mysore, the cultural capital of Karnataka, is famous for the grand
        <b>Mysore Palace</b>, royal heritage, yoga traditions, and vibrant festivals.
        <br><br>
        Known as the City of Palaces, Mysore reflects rich history, elegant architecture,
        and traditional South Indian culture.
        <br><br>
        Our Mysore tour packages include palace visits, temples, gardens,
        nearby hill excursions, and comfortable stays.
      </p>
    </div>

    <div class="wildlife-image">
      <img src="image/mysore1.jpg" alt="Mysore Palace">
    </div>
  </div>
</section>
...
<section class="section">
  <h2>Popular Mysore Tour Packages</h2>
  <div class="card-grid">

    <div class="card">
      <img src="image/mysore-1.jpg">
      <div class="card-content">
        <a href="#">
          1 Night & 2 Days
          <h4>Mysore Palace Tour</h4>
          <p>Palace, Chamundi Hill & Brindavan Gardens.</p>
        </a>
      </div>
    </div>

    <div class="card">
      <img src="image/coorg.jpg">
      <div class="card-content">
        <a href="#">
          2 Nights & 3 Days
          <h4>Mysore – Coorg</h4>
          <p>Heritage city & hill station getaway.</p>
        </a>
      </div>
    </div>

    <div class="card">
      <img src="image/bandipur.jpg">
      <div class="card-content">
        <a href="#">
          3 Nights & 4 Days
          <h4>Mysore with Bandipur</h4>
          <p>Wildlife safari & palace visit.</p>
        </a>
      </div>
    </div>

    <div class="card">
      <img src="image/karnatak.jpg">
      <div class="card-content">
        <a href="#">
          5 Nights & 6 Days
          <h4>Karnataka Heritage Tour</h4>
          <p>Bangalore, Mysore, Coorg & Ooty.</p>
        </a>
      </div>
    </div>
...
<section class="best-time-section">
  <div class="bt-container">
    <div class="bt-left">
      <h2>Best Time to Visit <br> Mysore</h2>
      ...
      <div class="bt-list">
        ...
        <div class="bt-item">
          ...
          <p>Warm but manageable.</p>
        </div>

        <div class="bt-item">
          <span>03</span>
          <h3>Dussehra Festival</h3>
          <p>Grand royal celebrations in October.</p>
        </div>
      </div>

      <div class="bt-text">
        <p>
          The Dussehra festival is the best time to experience
          Mysore’s royal grandeur and cultural richness.
        </p>
      </div>
    </div>

    <div class="bt-right">
      <img src="image/mysore-dussehra.jpg">
    </div>
  </div>
</section>
...
<section class="feedback-section" id="feedback-section">
  ...
  <div class="feedback-card active">
    <div class="feedback-text center">
      <h4>Royal & Beautiful</h4>
      <p>
        Mysore Palace was stunning and the tour was very well organized.
        Trailbliss made our trip memorable.
      </p>
      <p class="reviewer">– Ananya Rao</p>
    </div>
  </div>
</section>
...
<section class="about-section" id="about">
  <h2>About <span>Mysore Tourism</span></h2>
  <div class="about-content">
    <p class="intro">
      Mysore is a perfect blend of royal heritage, culture, and nature.
      Our packages include palaces, temples, gardens,
      wildlife sanctuaries, and hill stations of Karnataka.
    </p>
  </div>
</section>
