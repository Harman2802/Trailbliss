...
<head>
  ...
  <title>Hampta Pass Trek - Trailbliss</title>
...
<section class="main-title-section">
  <h1 class="main-title" style="color:#1e40af;">Hampta Pass Trek</h1>
  <p class="route">Manali – Jobra – Hampta Pass – Chandratal</p>
</section>

<!-- GALLERY -->
<section class="gallery">
  <div class="gallery-left">
    <img src="image/hampta-main.webp">
  </div>
  <div class="gallery-right">
    <img src="image/hampta-meadows.jpg">
    <img src="image/hampta-pass.jpg">
    <img src="image/hampta-river.jpg">
    <img src="image/chandratal.jpg">
  </div>
</section>
...
<section class="content-area">
  ...
  <div class="left-content">
    ...
    <div class="section-box">
      <h2>Overview</h2>
      <p>
        Hampta Pass Trek is one of the most scenic crossover treks in Himachal Pradesh,
        connecting the lush Kullu Valley with the stark landscapes of Lahaul.
        It offers dramatic terrain changes, river crossings, snow bridges, and
    ...
    <div class="section-box">
      <h2>Itinerary</h2>
      <ul class="itinerary">
        <li>Day 01: Manali to Jobra – Trek to Chika</li>
        <li>Day 02: Chika to Balu Ka Ghera</li>
        <li>Day 03: Balu Ka Ghera to Hampta Pass – Shea Goru</li>
        <li>Day 04: Shea Goru to Chatru – Drive to Chandratal</li>
        <li>Day 05: Return to Manali</li>
      </ul>
    </div>
  ...
  <div class="right-form">
    <h3 style="color:#1e40af;">Quick Query</h3>
...
<section class="about-goa" id="about">
  <h2>About Hampta Pass Trek</h2>
  <p>
    Hampta Pass is perfect for trekkers who want variety—green meadows,
    snowfields, glacial valleys, and desert landscapes all in one trek.
  </p>

  <div class="about-goa-grid">
    <div class="about-item">
      <i class="fa-solid fa-mountain"></i>
      <h4>High Altitude Pass</h4>
      <p>Cross a dramatic mountain pass at 14,100 ft.</p>
    </div>
    <div class="about-item">
      <i class="fa-solid fa-water"></i>
      <h4>River Crossings</h4>
      <p>Experience thrilling glacial river crossings.</p>
    </div>
    <div class="about-item">
      <i class="fa-solid fa-snowflake"></i>
      <h4>Snow Experience</h4>
      <p>Snow bridges and snowfields in early season.</p>
    </div>
    <div class="about-item">
      <i class="fa-solid fa-campground"></i>
      <h4>Camping</h4>
      <p>Scenic campsites surrounded by mountains.</p>
    </div>
  </div>
</section>
...
<section class="tour-section">
  <h2>Hampta Pass Trek – Complete Details</h2>

  <div class="tour-grid">

    <div class="tour-card">
      <h4><i class="fa-solid fa-calendar-days"></i> Best Time</h4>
      <p>June to September is ideal for snow, flowers, and clear views.</p>
    </div>

    <div class="tour-card">
      <h4><i class="fa-solid fa-gauge-high"></i> Difficulty</h4>
      <p>Moderate – suitable for fit beginners and experienced trekkers.</p>
    </div>

    <div class="tour-card">
      <h4><i class="fa-solid fa-route"></i> Distance & Altitude</h4>
      <p>Total Distance: ~26 km<br>Max Altitude: 14,100 ft</p>
    </div>

    <div class="tour-card">
      <h4><i class="fa-solid fa-users"></i> Who Can Trek?</h4>
      <p>Adventure lovers aged 14–55 with good fitness.</p>
    </div>

    <div class="tour-card">
      <h4><i class="fa-solid fa-bowl-food"></i> Meals</h4>
      <p>Healthy vegetarian meals throughout the trek.</p>
    </div>

    <div class="tour-card">
      <h4><i class="fa-solid fa-shield-halved"></i> Safety</h4>
      <p>Certified guides, medical kit, oxygen support.</p>
    </div>
...
<section class="customer-reviews" id="feedback-section">
  ...
  <div class="reviews-container">
    <div class="review-card">
      ...
      <p>Best crossover trek I’ve done in Himachal!</p>
    </div>
    <div class="review-card">
      <img src="image/user1.jpg">
      <h3>Neha Kapoor</h3>
      <span>Mumbai</span>
      <p>Landscape changes are unbelievable.</p>
    </div>
    <div class="review-card">
      <img src="image/user1.jpg">
      <h3>Daniel Scott</h3>
      <span>Canada</span>
      <p>Hampta Pass was challenging yet rewarding.</p>
    </div>
  </div>
</section>
