...
<head>
  ...
  <title>Kashmir Tour Packages - Trailbliss</title>
...
<!-- ================= HERO ================= -->
<div class="hero" style="background-image:url('image/kashmir-main.jpg');">
  <div class="hero-overlay"></div>
  <div class="hero-text">
    <div class="small-title">Paradise on Earth</div>
    <div class="big-title">Kashmir</div>
  </div>
</div>
...
<section class="destination-section">
  <div class="destination-container">
    <div class="destination-text">
      ...
      <p>
        Kashmir, often called <b>“Paradise on Earth”</b>, is famous for its snow-capped
        mountains, lush valleys, serene lakes, and beautiful gardens.
        <br><br>
        From the houseboats of Dal Lake to the meadows of Gulmarg and Pahalgam,
        Kashmir offers unmatched natural beauty and peace.
        <br><br>
        Our Kashmir packages include sightseeing, shikara rides, snow activities,
        luxury stays, and comfortable local travel.
      </p>
    </div>

    <div class="destination-image">
      <img src="image/ka1.jpg" alt="Kashmir Valley">
    </div>
  </div>
</section>
...
<section class="section">
  <h2>Popular Kashmir Tour Packages</h2>

  <div class="card-grid">

    <div class="card">
      <img src="image/ka2.jpg">
      <div class="card-content">
        <a href="#">
          3 Nights & 4 Days
          <h4>Srinagar Special</h4>
          <p>Dal Lake, Mughal Gardens & houseboat stay.</p>
        </a>
      </div>
    </div>

    <div class="card">
      <img src="image/ka3.jpg">
      <div class="card-content">
        <a href="#">
          4 Nights & 5 Days
          <h4>Srinagar – Gulmarg</h4>
          <p>Snow activities & gondola ride.</p>
        </a>
      </div>
    </div>

    <div class="card">
      <img src="image/ka4.jpg">
      <div class="card-content">
        <a href="#">
          5 Nights & 6 Days
          <h4>Kashmir Valley Tour</h4>
    ...
    <div class="card">
      <img src="image/ka5.jpg">
      <div class="card-content">
        <a href="#">
          6 Nights & 7 Days
          <h4>Kashmir Honeymoon Package</h4>
          <p>Romantic stays & scenic valleys.</p>
        </a>
      </div>
    </div>
...
<section class="best-time-section">
  <div class="bt-container">
    ...
    <div class="bt-left">
      <h2>Best Time to Visit <br> Kashmir</h2>
      ...
      <div class="bt-list">
        ...
        <div class="bt-item">
          ...
          <p>Blooming gardens & pleasant weather.</p>
        </div>

        <div class="bt-item">
          <span>02</span>
          <h3>Summer (Jun – Aug)</h3>
          <p>Perfect for sightseeing & escapes.</p>
        </div>

        <div class="bt-item">
          <span>03</span>
          <h3>Winter (Dec – Feb)</h3>
          <p>Snowfall & winter sports.</p>
        </div>
      ...
      <div class="bt-text">
        <p>
          Spring and summer are ideal for scenic beauty,
          while winter is best for snow lovers.
        </p>
      </div>
    </div>

    <div class="bt-right">
      <img src="image/ka6.jpg">
    </div>
...
<section class="feedback-section" id="feedback-section">
  ...
  <div class="feedback-card active">
    <div class="feedback-text center">
      <h4>Truly Paradise</h4>
      <p>
        Kashmir was beyond beautiful. From Dal Lake to Gulmarg,
        everything was perfectly arranged by Trailbliss.
      </p>
...
<section class="about-section" id="about">
  <h2>About <span>Kashmir Tourism</span></h2>
  <div class="about-content">
    <p class="intro">
      Kashmir is known for its breathtaking landscapes,
      warm hospitality, and rich culture. A perfect destination
