...
<head>
  ...
  <title>Jaisalmer Desert Safari - Trailbliss</title>
...
<section class="main-title-section">
  <h1 class="main-title" style="color:#ff9800;">Jaisalmer Desert Safari</h1>
  <p class="route">Sam Sand Dunes – Camel Safari – Desert Camping – Cultural Show</p>
</section>

<!-- GALLERY -->
<section class="gallery">
  <div class="gallery-left">
    <img src="image/jaisalmer-main.jpg" alt="Jaisalmer Desert">
  </div>
  <div class="gallery-right">
    <img src="image/camel-safari.jpg" alt="Camel Safari">
    <img src="image/desert-camping.jpg" alt="Desert Camping">
    <img src="image/sam-sand-dunes.jpg" alt="Sam Sand Dunes">
    <img src="image/cultural-show.jpg" alt="Cultural Show">
  </div>
</section>
...
<section class="content-area">
  ...
  <div class="left-content">
    ...
    <div class="section-box">
      <h2>Overview</h2>
      <p>
        Jaisalmer, the "Golden City" of Rajasthan, offers a magical desert experience.
        Explore the golden sand dunes, enjoy camel rides, desert camping, and
        traditional Rajasthani cultural performances. Ideal for adventure seekers,
    ...
    <div class="section-box">
      <h2>Itinerary</h2>
      <ul class="itinerary">
        <li>Day 01: Arrival at Jaisalmer – Check-in & Leisure</li>
        <li>Day 02: Sam Sand Dunes – Camel Safari & Sunset</li>
        <li>Day 03: Desert Camping & Cultural Program</li>
        <li>Day 04: Visit Jaisalmer Fort & Patwon Ki Haveli</li>
  ...
  <div class="right-form">
    <h3 style="color:#ff9800;">Quick Query</h3>
...
<section class="about-goa" id="about">
  ...
  <p>
    Jaisalmer is known for its golden fort, sand dunes, and vibrant desert culture.
    The city offers a perfect combination of adventure, history, and cultural experiences.
  </p>

  <div class="about-goa-grid">
    <div class="about-item">
      <i class="fa-solid fa-camel"></i>
      <h4>Camel Safari</h4>
      <p>Ride through the vast golden dunes on camelback.</p>
    </div>
    <div class="about-item">
      <i class="fa-solid fa-campground"></i>
      <h4>Desert Camping</h4>
      <p>Experience an overnight stay under the starry desert sky.</p>
    </div>
    <div class="about-item">
      <i class="fa-solid fa-theater-masks"></i>
      <h4>Cultural Show</h4>
      <p>Enjoy folk dances, music, and traditional performances.</p>
    </div>
    <div class="about-item">
      <i class="fa-solid fa-landmark"></i>
      <h4>Historic Forts</h4>
      <p>Explore Jaisalmer Fort and the magnificent Havelis.</p>
    </div>
  </div>
</section>
...
<section class="tour-section">
  <h2>Popular Jaisalmer Packages</h2>
  <div class="tour-grid">
    <div class="tour-card">
      <img src="image/safari1.jpg" alt="Golden Desert Safari">
      <h4>Golden Desert Safari</h4>
      <p>3 Nights / 4 Days</p>
    </div>
    <div class="tour-card">
      <img src="image/safari2.jpg" alt="Romantic Desert Experience">
      <h4>Romantic Desert Experience</h4>
      <p>4 Nights / 5 Days</p>
    </div>
    <div class="tour-card">
      <img src="image/safari3.jpg" alt="Adventure Desert Trip">
      <h4>Adventure Desert Trip</h4>
      <p>5 Nights / 6 Days</p>
    </div>
  </div>
</section>
...
<section class="customer-reviews" id="feedback-section">
  ...
  <div class="reviews-container">
    <div class="review-card">
      ...
      <h3>Amit Singh</h3>
      <span>Jaipur</span>
      <p>Desert camping and camel safari was an unforgettable experience!</p>
    </div>
    <div class="review-card">
      <img src="image/user1.jpg" alt="Traveler">
      <h3>Priya Sharma</h3>
      <span>Delhi</span>
      <p>The cultural show and sunset in the dunes was magical. Loved it!</p>
    </div>
    <div class="review-card">
      <img src="image/user1.jpg" alt="Traveler">
      <h3>Michael Lee</h3>
      <span>USA</span>
      <p>Perfect blend of adventure and heritage. Highly recommended.</p>
    </div>
  </div>
</section>
