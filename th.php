<!-- Save as thailand.php -->
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Trailbliss - Thailand Tour Packages</title>
...
<style>
/* KEEP SAME CSS STRUCTURE */
.hero{height:75vh;background:url("image/thailand.jpg") center/cover no-repeat;display:flex;align-items:center;justify-content:center;position:relative;color:white;}
...
@media(max-width:900px){.content-area,.best-time-wrapper{grid-template-columns:1fr;}.big-title{font-size:40px;}}
</style>
</head>
...
<section class="hero">
<div class="hero-text">
<div class="small-title">Land of Smiles</div>
<div class="big-title">Thailand</div>
</div>
</section>

<section class="container">
<h2 class="main-title">Thailand Tour Packages</h2>

<div class="content-area">
<div class="section-box">
<p>Thailand is famous for beaches, islands, nightlife, temples, and street food. From Bangkok to Phuket and Krabi, it offers adventure and relaxation together.</p>
</div>

<div class="right-content">
<img src="image/tl1.jpg">
</div>
</div>
</section>
...
<li><strong>Nov–Feb</strong><span>Best weather & beach season</span></li>
<li><strong>Mar–May</strong><span>Hot but less crowded</span></li>
<li><strong>Jun–Oct</strong><span>Green season & discounts</span></li>
</ul>

<div class="best-time-img">
<img src="image/tl2.jpg">
</div>
</div>
</section>
