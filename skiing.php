...
<head>
  ...
  <title>Skiing Adventure - Trailbliss</title>
...
<section class="main-title-section">
  <h1 class="main-title" style="color:#ff5722;">Skiing Adventure</h1>
  <p class="route">Gulmarg – Manali – Auli – Snow Slopes</p>
</section>

<!-- GALLERY -->
<section class="gallery">
  <div class="gallery-left">
    <img src="image/skiing-main.jpg" alt="Skiing Adventure">
  </div>
  <div class="gallery-right">
    <img src="image/skiing-slopes.jpg" alt="Snow Slopes">
    <img src="image/skiing-training.jpg" alt="Ski Training">
    <img src="image/skiing-mountains.jpg" alt="Mountain View">
    <img src="image/skiing-resort.jpg" alt="Ski Resort">
  </div>
</section>
...
<section class="content-area">
  ...
  <div class="left-content">
    ...
    <div class="section-box">
      <h2>Overview</h2>
      <p>
        Experience the thrill of skiing on pristine snow slopes in India’s top winter destinations.
        Perfect for adventure enthusiasts, thrill seekers, and winter sports lovers.
        Explore Gulmarg, Manali, and Auli with expert instructors and safe equipment.
      </p>
    </div>
    ...
    <div class="section-box">
      ...
      <ul class="itinerary">
        ...
        <li>Day 02: Skiing Lessons & Practice Slopes</li>
        <li>Day 03: Full Day Skiing Adventure</li>
        <li>Day 04: Mountain Exploration & Snow Activities</li>
  ...
  <div class="right-form">
    <h3 style="color:#ff5722;">Quick Query</h3>
...
<section class="about-goa" id="about">
  <h2>About Skiing</h2>
  <p>
    Skiing is an exhilarating winter sport that allows you to glide over snow-covered slopes,
    enjoy breathtaking mountain views, and experience the adrenaline rush of winter adventure.
  </p>

  <div class="about-goa-grid">
    <div class="about-item">
      <i class="fa-solid fa-mountain-sun"></i>
      <h4>Snowy Mountains</h4>
      <p>Explore scenic slopes and majestic mountain views.</p>
    </div>
    <div class="about-item">
      <i class="fa-solid fa-person-skiing"></i>
      <h4>Guided Skiing</h4>
      <p>Expert instructors ensure safe and fun skiing experience.</p>
    </div>
    <div class="about-item">
      <i class="fa-solid fa-skiing-nordic"></i>
      <h4>Winter Sports</h4>
      <p>Skiing, snowboarding, and other exciting snow activities.</p>
    </div>
    <div class="about-item">
      <i class="fa-solid fa-hotel"></i>
      <h4>Resort Stay</h4>
      <p>Stay in cozy resorts with stunning mountain views.</p>
    </div>
  </div>
</section>
...
<section class="tour-section">
  <h2>Popular Skiing Packages</h2>
  <div class="tour-grid">
    <div class="tour-card">
      <img src="image/skiing-slopes.jpg" alt="Beginner Ski">
      <h4>Beginner Ski</h4>
      <p>2 Nights / 3 Days</p>
    </div>
    <div class="tour-card">
      <img src="image/skiing-mountains.jpg" alt="Advanced Ski">
      <h4>Advanced Ski</h4>
      <p>3 Nights / 4 Days</p>
    </div>
    <div class="tour-card">
      <img src="image/skiing-training.jpg" alt="Snow Explorer">
      <h4>Snow Explorer</h4>
      <p>4 Nights / 5 Days</p>
    </div>
  </div>
...
<section class="customer-reviews" id="feedback-section">
  ...
  <div class="reviews-container">
    <div class="review-card">
      ...
      <h3>Arjun Mehta</h3>
      <span>Delhi</span>
      <p>Thrilling experience! Perfect slopes and helpful instructors.</p>
    </div>
    <div class="review-card">
      <img src="image/user1.jpg" alt="Traveler">
      <h3>Riya Sharma</h3>
      <span>Mumbai</span>
      <p>Snow adventure was unforgettable. Loved skiing on pristine slopes!</p>
    </div>
    <div class="review-card">
      <img src="image/user1.jpg" alt="Traveler">
      <h3>David Clark</h3>
      <span>USA</span>
      <p>Beautiful locations and great skiing experience. Highly recommended!</p>
    </div>
  </div>
</section>
