...
<head>
  ...
  <title>Trailbliss - Konark Tour Packages</title>
...
<!-- HERO -->
<div class="hero" style="background-image:url('image/konark-main.jpg');">
  <div class="hero-overlay"></div>
  <div class="hero-text">
    <div class="small-title">Welcome to Odisha</div>
    <div class="big-title">Konark</div>
  </div>
</div>
...
<section class="wildlife-section">
  <div class="wildlife-container">
    <div class="wildlife-text">
      <h1>Konark Tour Packages</h1>
      <p>
        Konark is world-famous for the magnificent <b>Sun Temple</b>, a UNESCO World
        Heritage Site known for its stunning stone carvings and chariot-shaped architecture.
        <br><br>
        Built in the 13th century, the temple is dedicated to the Sun God and represents
        Odisha’s glorious heritage, art, and devotion.
        <br><br>
        Our Konark tour packages include Sun Temple visits, Puri Jagannath Temple,
        Chandrabhaga Beach, Chilika Lake excursions, and comfortable stays.
      </p>
    </div>

    <div class="wildlife-image">
      <img src="image/konark.jpg" alt="Konark Sun Temple">
    </div>
  </div>
</section>
...
<section class="section">
  <h2>Popular Konark Tour Packages</h2>
  <div class="card-grid">
    ...
    <div class="card">
      ...
      <div class="card-content">
        <a href="#">
          1 Night & 2 Days
          <h4>Konark Sun Temple Tour</h4>
          <p>Sun Temple, museum & Chandrabhaga Beach.</p>
        </a>
      </div>
    </div>

    <div class="card">
      <img src="image/puri.jpg">
      <div class="card-content">
        <a href="#">
          2 Nights & 3 Days
          <h4>Konark – Puri Combo</h4>
          <p>Sun Temple & Jagannath Temple darshan.</p>
        </a>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="card-content">
        <a href="#">
          3 Nights & 4 Days
          <h4>Konark with Chilika Lake</h4>
          <p>Boat ride & dolphin spotting.</p>
        </a>
      </div>
    </div>

    <div class="card">
      <img src="image/odisha1.jpg">
      <div class="card-content">
        <a href="#">
          5 Nights & 6 Days
          <h4>Odisha Heritage Tour</h4>
          <p>Bhubaneswar, Konark, Puri & Chilika.</p>
        </a>
      </div>
    </div>
...
<section class="best-time-section">
  <div class="bt-container">
    <div class="bt-left">
      <h2>Best Time to Visit <br> Konark</h2>

      <div class="bt-list">
        <div class="bt-item">
          <span>01</span>
          <h3>Winter (Oct – March)</h3>
          <p>Pleasant weather for temple visits.</p>
        </div>

        <div class="bt-item">
          <span>02</span>
          <h3>Summer (April – June)</h3>
          <p>Hot but early mornings are ideal.</p>
        </div>

        <div class="bt-item">
          <span>03</span>
          <h3>Konark Dance Festival</h3>
          <p>Classical dance performances in December.</p>
        </div>
      </div>

      <div class="bt-text">
        <p>
          Winter is the best season to explore Konark.
          The Konark Dance Festival adds cultural charm.
        </p>
      </div>
    </div>

    <div class="bt-right">
      <img src="image/konark-festival.jpg">
    </div>
  </div>
</section>
...
<section class="feedback-section" id="feedback-section">
  ...
  <div class="feedback-card active">
    <div class="feedback-text center">
      <h4>Architectural Wonder</h4>
      <p>
        The Konark Sun Temple tour arranged by Trailbliss
        was informative, peaceful, and well managed.
      </p>
      <p class="reviewer">– Rakesh Mishra</p>
    </div>
  </div>
</section>
...
<section class="about-section" id="about">
  <h2>About <span>Konark Tourism</span></h2>
  <div class="about-content">
    <p class="intro">
      Konark is one of India’s greatest architectural marvels.
      Our packages cover Konark Sun Temple, Puri Jagannath Temple,
      Chilika Lake, beaches, and Odisha’s cultural heritage with expert guides.
    </p>
  </div>
</section>
