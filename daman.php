...
<head>
  ...
  <title>Daman Beach Tour - Trailbliss</title>
...
<section class="main-title-section">
  <h1 class="main-title" style="color:#5d4037;">Daman Beach Tour</h1>
  <p class="route">Devka Beach – Jampore Beach – St. Jerome Fort – Portuguese Heritage</p>
</section>

<!-- GALLERY -->
<section class="gallery">
  <div class="gallery-left">
    <img src="image/d1.jpg" alt="Daman Beach">
  </div>
...
<section class="content-area">
  ...
  <div class="left-content">
    ...
    <div class="section-box">
      <h2>Overview</h2>
      <p>
        Daman is a charming coastal town known for its relaxed beaches,
        colonial Portuguese architecture and peaceful seaside ambiance.
    ...
    <div class="section-box">
      <h2>Itinerary</h2>
      <ul class="itinerary">
        <li>Day 01: Arrival – Devka Beach Sunset</li>
        <li>Day 02: Jampore Beach & St. Jerome Fort</li>
        <li>Day 03: Churches, Local Markets & Departure</li>
      </ul>
    </div>
  ...
  <div class="right-form">
    <h3 style="color:#5d4037;">Quick Query</h3>
...
<section class="about-goa" id="about">
  <h2>About Daman</h2>
  <p>
    Daman offers a perfect blend of beaches, heritage and leisure.
    Its Portuguese forts, serene beaches and laid-back lifestyle
    attract travelers looking for calm and comfort.
  </p>
  ...
  <div class="about-goa-grid">
    <div class="about-item">
      ...
      <h4>Devka Beach</h4>
      <p>Rocky shoreline with beautiful evening views.</p>
    </div>
    <div class="about-item">
      <i class="fa-solid fa-water"></i>
      <h4>Jampore Beach</h4>
      <p>Wide sandy beach ideal for swimming.</p>
    </div>
    <div class="about-item">
      <i class="fa-solid fa-landmark"></i>
      <h4>Portuguese Heritage</h4>
      <p>Forts and churches reflecting colonial charm.</p>
    </div>
    <div class="about-item">
      <i class="fa-solid fa-mug-hot"></i>
      <h4>Relaxed Getaway</h4>
      <p>Perfect for weekend breaks and leisure trips.</p>
    </div>
  </div>
</section>
...
<section class="tour-section">
  <h2>Popular Daman Packages</h2>
  <div class="tour-grid">
    <div class="tour-card">
      <img src="image/goa-calangute.jpg">
      <h4>Daman Weekend Escape</h4>
      <p>2 Nights / 3 Days</p>
    </div>
    <div class="tour-card">
      <img src="image/ko5.jpg">
      <h4>Daman Heritage Tour</h4>
      <p>3 Nights / 4 Days</p>
    </div>
    <div class="tour-card">
      <img src="image/ko7.jpg">
      <h4>Beach & Leisure Trip</h4>
      <p>4 Nights / 5 Days</p>
    </div>
  </div>
</section>
...
<section class="customer-reviews" id="feedback-section">
  ...
  <div class="reviews-container">
    <div class="review-card">
      ...
      <h3>Rohit Patel</h3>
      <span>Surat</span>
      <p>Peaceful beaches and beautiful heritage sites.</p>
    </div>
    <div class="review-card">
      <img src="image/user1.jpg">
      <h3>Anjali Mehta</h3>
      <span>Ahmedabad</span>
      <p>Perfect short getaway from city life.</p>
    </div>
    <div class="review-card">
      <img src="image/user1.jpg">
      <h3>Mark Wilson</h3>
      <span>USA</span>
      <p>Quiet beaches with colonial charm.</p>
    </div>
  </div>
</section>
