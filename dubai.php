...
<section class="hero">
  <div class="hero-text">
    <div class="small-title">City of Luxury</div>
    <div class="big-title">Dubai</div>
  </div>
</section>

<!-- INTRO -->
<section class="container">
  <h2 class="main-title">Dubai Tour Packages</h2>

  <div class="content-area">
    <div class="section-box">
      <p>
        Dubai is a world-famous luxury destination known for its futuristic skyline, Burj Khalifa, luxury shopping malls, desert safaris, and man-made wonders like Palm Jumeirah.  
        It offers a perfect blend of modern architecture, adventure activities, luxury hotels, and cultural experiences. From desert adventures to sky-high dining, Dubai is a dream destination for travelers.
      </p>
    </div>

    <div class="right-content">
      <img src="image/dubai1.jpg">
    </div>
  </div>
</section>
...
<section class="container">
  ...
  <div class="best-time-wrapper">
    ...
    <ul class="best-time-list">
      <li>
        <strong>Winter (Nov–Mar)</strong>
        <span>Best weather for sightseeing & outdoor activities.</span>
      </li>

      <li>
        <strong>Summer (Apr–Oct)</strong>
        <span>Great for indoor luxury malls & resorts.</span>
      </li>

      <li>
        <strong>Festival Season</strong>
        <span>Dubai Shopping Festival & events.</span>
      </li>
    </ul>

    <div class="best-time-img">
      <img src="image/dubai2.jpg">
    </div>
