...
<head>
  ...
  <title>Hill Station Tours - Trailbliss</title>
...
<!-- MAIN TITLE -->
<div class="container">
  <h1 class="main-title">Indian Hill Station Tours</h1>
  <p class="route">Manali - Shimla - Kashmir - Darjeeling</p>

  <!-- IMAGE GALLERY -->
  <div class="gallery">
    <div class="gallery-left">
      <img src="image/hill-main.jpg" alt="Hill Station">
    </div>
    <div class="gallery-right">
      <img src="image/manali.jpg" alt="Manali">
      <img src="image/shimla.jpg" alt="Shimla">
      <img src="image/kashmir.jpg" alt="Kashmir">
      <img src="image/darjeeling.jpg" alt="Darjeeling">
    </div>
  </div>
  ...
  <div class="content-area">
    ...
    <div class="left-content">
      <div class="section-box">
        <h2>Overview</h2>
        <p>
          Escape to the peaceful mountains with breathtaking landscapes, snow-capped peaks,
          lush forests, waterfalls, and adventure sports. Perfect for honeymooners, families,
          and nature lovers.
        </p>
      </div>
      ...
      <div class="section-box">
        <h2>Itinerary</h2>
        <ul class="itinerary">
          <li>Day 01: Arrival in Delhi – Transfer to Shimla</li>
          <li>Day 02: Shimla Sightseeing – Kufri & Mall Road</li>
          <li>Day 03: Shimla – Manali via scenic route</li>
          <li>Day 04: Manali – Solang Valley / Rohtang Pass</li>
          <li>Day 05: Manali Local Sightseeing</li>
          <li>Day 06: Fly to Srinagar – Shikara Ride</li>
          <li>Day 07: Return with beautiful memories</li>
        </ul>
      </div>
    </div>
  ...
  <div class="tour-section">
    ...
    <div class="tour-grid">
      ...
      <div class="tour-card">
        <img src="image/darjeeling.jpg" alt="Darjeeling Tour">
  ...
  <div class="tour-section">
    ...
    <div class="tour-grid">
      ...
      <div class="tour-card">
        <img src="image/mussoorie.jpg" alt="Mussoorie">
        <h4>Mussoorie Hills</h4>
      </div>

      <div class="tour-card">
        <img src="image/sikkim.jpg" alt="Sikkim">
        <h4>Sikkim & Gangtok</h4>
      </div>
...
<section class="customer-reviews">
  ...
  <section id="about">
    <h2>About Hill Station Tours</h2>
    <p>
      Experience India's most famous hill stations with cool weather, scenic views, trekking,
      cable cars, adventure sports, and cosy stays in the mountains.
    </p>

    <div class="about-grid">
      <div>
        <h4>Snow Adventures</h4>
        <p>Enjoy skiing, snowboarding, paragliding, and more in Himalayan regions.</p>
      </div>

      <div>
        <h4>Nature Trails</h4>
        <p>Explore pine forests, tea gardens, waterfalls, and national parks.</p>
      </div>

      <div>
        <h4>Scenic Views</h4>
        <p>Capture stunning sunrises, sunset points, and valleys covered in clouds.</p>
      </div>

      <div>
        <h4>Relaxing Holidays</h4>
        <p>Perfect getaway from city crowd — peaceful vibes with fresh mountain air.</p>
      </div>
    </div>
  </section>
<!-- Footer -->
