...
.hero{
height:75vh;
background:url("image/sydney.jpg") center/cover no-repeat;
display:flex;align-items:center;justify-content:center;position:relative;color:white;
}
.hero::before{content:"";position:absolute;inset:0;background:rgba(0,0,0,0.5);}
.hero-text{position:relative;text-align:center;}

.small-title{font-size:18px;letter-spacing:2px;}
...
.section-box{background:#fff;padding:25px;border-radius:15px;box-shadow:0 8px 20px rgba(0,0,0,0.05);line-height:1.7;}
.right-content img{width:100%;border-radius:15px;}

.best-time-wrapper{display:grid;grid-template-columns:1fr 1fr;gap:25px;align-items:center;background:white;padding:25px;border-radius:15px;box-shadow:0 8px 20px rgba(0,0,0,0.06);}
.best-time-list{list-style:none;}
.best-time-list li{margin-bottom:18px;padding:15px;background:#f8f8f8;border-left:5px solid #d13d70;border-radius:10px;}
.best-time-list strong{display:block;margin-bottom:5px;}
.best-time-list span{font-size:14px;color:#666;}
.best-time-img img{width:100%;border-radius:12px;}

footer{background:#000;color:#fff;text-align:center;padding:25px;margin-top:40px;}

@media(max-width:900px){
.content-area,.best-time-wrapper{grid-template-columns:1fr;}
...
<section class="hero">
  <div class="hero-text">
    <div class="small-title">Harbour City</div>
    <div class="big-title">Sydney</div>
  </div>
</section>

<section class="container">
<h2 class="main-title">Sydney Tour Packages</h2>

<div class="content-area">
<div class="section-box">
<p>
Sydney is Australia’s most iconic city known for Sydney Opera House, Harbour Bridge, beaches and vibrant lifestyle. It offers world-class dining, cruises, and scenic coastal views.
</p>
</div>
...
<li><strong>Sep–Nov</strong><span>Spring season & pleasant weather</span></li>
<li><strong>Dec–Feb</strong><span>Beach activities & festivals</span></li>
<li><strong>Mar–May</strong><span>Less crowd & mild climate</span></li>
</ul>
